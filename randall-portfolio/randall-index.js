function promptForSecretCode() {
    ...
    if (secretCode === "rstlne") { // Replace with your actual secret code
        window.location.href = "./bc4150d023d3255136db671d61ac93f2/RSTLNE.html"; // Redirect to the secret page
    } else {
        alert("Incorrect secret code. Please try again.");
        // Change the stylesheet dynamically
        changeStylesheet("bc4150d023d3255136db671d61ac93f2/rstlne.css"); // Replace "incorrect.css" with the path to your stylesheet
        invertColors();
    }
}
